    ...
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative flex flex-1 flex-col z-20 xl:w-1/2">
        ...
        <div className="flex flex-col w-full gap-3 sm:flex-row">
          <Buttton type="button" title="Download App" varient="btn_green" />
          <Buttton
            type="button"
            title="How we work?"
            icon="/play.svg"
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 rounded-3xl gap-8 flex flex-col w-[268px] bg-green-90 px-7 py-8">
          ...
          <div className="flexBetween">
            <div className="flex flex-col">
              ...
              <p className="bold-20 text-white">178.58 mi</p>
            </div>
            <div className="flex flex-col">
